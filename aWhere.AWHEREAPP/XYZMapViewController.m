...
- (void)initLocList {
    // get a reference to our global data set
    BarDataManager *sharedData = [BarDataManager sharedManager];
    ...
    bar6.name = @"Scorekeeper's Bar and Grill";
    bar6.price = @"$3.00";
    bar6.rating = @"4";
    bar6.category = @"Bar";
